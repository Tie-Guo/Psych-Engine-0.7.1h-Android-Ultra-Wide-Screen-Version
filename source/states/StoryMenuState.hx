...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x + grpWeekText.members[0].width + 70, grpWeekText.members[0].y + 10);
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07 + 30, bgSprite.y + 425).loadGraphic(Paths.image('Menu_Tracks'));
